> **Source of truth:** This document is mirrored for the documentation site. The authoritative version lives in [`/adrs/adr-005-email-as-transport.md`](https://github.com/AIXP-Labs/AIVP/blob/main/adrs/adr-005-email-as-transport.md). Edits MUST go to the authoritative file first.
